...
namespace OdinPlus
{
	...
	{
		static Dictionary<string, Vector3> s_questPinPositions = new();

		protected override void Awake()
		{
			base.Awake();
			m_name = "Messenger";
			ChoiceList = new[] { "$op_talk", "Take Message Quest" };
		}
