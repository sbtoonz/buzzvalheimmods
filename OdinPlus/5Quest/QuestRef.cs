...
namespace OdinPlus
{
	...
	{
		internal static List<string[]> DungeonLoc = new()
		{
			new string[]{ "Crypt3" },
		...
		internal static List<string[]> TreasureLoc = new()
		{
		...
		internal static List<string[]> HuntLoc = new()
		{
		...
		internal static List<string[]> SearchItem = new()
		{
		...
		internal static Dictionary<QuestType, List<string[]>> LocDic = new()
		{
			{QuestType.Dungeon,DungeonLoc},{QuestType.Hunt,HuntLoc},{QuestType.Search,SearchItem},{QuestType.Treasure,TreasureLoc}
		};
		internal static string[] HunterMonsterList = new string[] { "Troll", "Draugr_Elite", "Fenring", "GoblinBrute" };
	}
}
